...
public class Room {
  ...
  public Room id(@jakarta.annotation.Nonnull Integer id) {
  ...
  public Room name(@jakarta.annotation.Nonnull String name) {
  ...
  public Room sort(@jakarta.annotation.Nonnull Integer sort) {
